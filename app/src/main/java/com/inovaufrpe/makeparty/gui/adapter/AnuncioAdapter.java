...
public class AnuncioAdapter extends RecyclerView.Adapter<AnuncioAdapter.AnunciosViewHolder> {
    private final List<AnuncioView> anuncios;
    ...
    public AnuncioAdapter(Context context, List<AnuncioView> anuncios, AnuncioOnClickListener onClickListener) {
    ...
    public void onBindViewHolder(final AnunciosViewHolder holder, final int position) {
        Anuncio anuncio = anuncios.get(position).getAnuncio();
        //Bitmap imagemAnuncio = anuncio.getImagemBitmap();
        //holder.imageView.setImageBitmap(imagemAnuncio);
